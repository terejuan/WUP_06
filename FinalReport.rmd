...
```
the only difference we can see is that black and white are different, and white and other are the same, there is no difference between them they are both in favor of capital punishment. the black and others are different, others are more in favor than black.
